              ...
              <div class="card">
                ...
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('uploads/'.$pizza->image) }}" class="img-thumbnail mhy-3" width="120px">
                    </div>
                    ...
                    <div class="active tab-pane" id="activity">
                      <form class="form-horizontal" method="post" action="{{ route('admin#updatePizza',$pizza->pizza_id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="file" class="form-control"   placeholder="Enter Image" name="image" value="{{ old('image',$pizza->image) }}">
                              @if($errors->has('image'))
